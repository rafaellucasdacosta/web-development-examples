...
<body>
   ...
   <section id="panel">
      ...
      <form method="post" action="process_new.php">
         ...
         <input type="text" id="txtUsername" class="input-text" name="username" size="50" placeholder="nome de usuário"/><br />
         ...
         <input type="date" id="txtDataNascimento" class="input-text" name="birthDate" size="50" placeholder="data de nascimento"/><br />
